...
- [If you get stuck](./START-HERE.md#if-you-get-stuck)
- [Foundry-first data model](./START-HERE.md#foundry-first-data-model)
- [Upload the seed data](./START-HERE.md#upload-the-seed-data)
...
This is a Foundry-first skeleton. The TODO comments in [`foundry_client.py`](./src/contoso_lab/foundry_client.py) tell you exactly where to add Agent Framework code, how to build agents with `FoundryChatClient`, where to attach tools, and how to validate outputs with the Pydantic models.
